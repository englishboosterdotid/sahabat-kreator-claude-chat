  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        className={cn(
          "fixed z-50 bg-card text-card-foreground shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded-lg p-2 hover:bg-accent">
          <X className="size-4" />
